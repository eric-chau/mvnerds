	...
	$itemSidebarList.on('mouseover', '.btn-describe-block-item', function() {
		if($(this).data('popover') == undefined) {
			...
			$(this).popover({
				...
				content: '',
				template: '<div class="popover bloc-description-popover" data-source="#'+$this.parents('.item-sidebar-block-li').attr('id')+'"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-title"></h3><div class="popover-contenu"><textarea></textarea></div><div class="popover-footer"><a href="#" class="save-bloc-description action">Enregistrer</a><a href="#" class="cancel-save-bloc-description action">Annuler</a></div></div></div>'
			});
