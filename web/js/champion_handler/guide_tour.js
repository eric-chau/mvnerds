...
guiders.createGuider({
  buttons: [{name: "<em>F</em>in de la visite, merci !", classString: "btn-close", onclick: guiders.hideAll}],
  description: "Deux champions doivent être au minimum présent dans la liste pour pouvoir démarrer une comparaison. A noter que vous pouvez comparer au maximum x champions simultanément.",
   id: "finally",
